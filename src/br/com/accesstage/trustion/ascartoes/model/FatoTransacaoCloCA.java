 ...
 */
@Entity
@Table(name = "FATO_TRANSACAO_CLO")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "FatoTransacaoClo.findAll", query = "SELECT f FROM FatoTransacaoCloCA f"),
    @NamedQuery(name = "FatoTransacaoClo.findByNroNsu", query = "SELECT f FROM FatoTransacaoCloCA f WHERE f.nroNsu = :nroNsu"),
    @NamedQuery(name = "FatoTransacaoClo.findByHash", query = "SELECT f FROM FatoTransacaoCloCA f WHERE f.hashValue = :hashValue")
})
public class FatoTransacaoCloCA implements Serializable {

    private static final long serialVersionUID = -3533130234080711678L;
    ...
    public FatoTransacaoCloCA() {
    }

    public FatoTransacaoCloCA(String hashValue) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FatoTransacaoCloCA)) {
            return false;
        }
        FatoTransacaoCloCA other = (FatoTransacaoCloCA) object;
    ...
    public String toString() {
        return "br.com.accesstage.ascartoes.entity.FatoTransacaoClo[ hashValue=" + hashValue + " ]";
    }
