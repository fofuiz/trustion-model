 ...
 */
@Entity
@Table(name = "FATO_TRANSACAO_ELV")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "FatoTransacaoElv.findAll", query = "SELECT f FROM FatoTransacaoElvCA f"),
    @NamedQuery(name = "FatoTransacaoElv.findByNroNsu", query = "SELECT f FROM FatoTransacaoElvCA f WHERE f.nroNsu = :nroNsu"),
    @NamedQuery(name = "FatoTransacaoElv.findByHash", query = "SELECT f FROM FatoTransacaoElvCA f WHERE f.hashValue = :hashValue")
})
public class FatoTransacaoElvCA implements Serializable {

    private static final long serialVersionUID = 8694240885295742830L;
    ...
    public FatoTransacaoElvCA() {
    }

    public FatoTransacaoElvCA(String hashValue) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FatoTransacaoElvCA)) {
            return false;
        }
        FatoTransacaoElvCA other = (FatoTransacaoElvCA) object;
    ...
    public String toString() {
        return "br.com.accesstage.ascartoes.entity.FatoTransacaoElv[ hashValue=" + hashValue + " ]";
    }
